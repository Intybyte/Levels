...
public enum WeaponAttribute implements AttributeBase, SimpleConfigAttribute {
    ...
    CHAINED("Chained", LegacyTextColor.WHITE, AttributeRarity.LEGENDARY,0, 0),
    ...
    WeaponAttribute(String baseName, LegacyTextColor color, AttributeRarity rarity, double defaultBaseValue, double defaultMultiplier) {
